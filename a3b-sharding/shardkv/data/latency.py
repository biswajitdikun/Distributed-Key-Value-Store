...
filename1 = 'data/A.txt'  # Replace with your first file name
data1 = np.loadtxt(filename1)

# Step 2: Read data from the second file
filename2 = 'data/B.txt'  # Replace with your second file name
data2 = np.loadtxt(filename2)

# Step 3: Read data from the third file
filename3 = 'data/C.txt'  # Replace with your third file name
